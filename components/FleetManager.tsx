                              ...
                              {newCar.features && (
                                  <div className="flex flex-wrap gap-1 mt-2">
                                      {newCar.features.map((f, i) => (
                                          <span key={i} className="text-xs bg-white border px-2 py-0.5 rounded-full text-slate-600">{f}</span>
                                      ))}
                                  </div>
                              )}
                          </div>
                 ...
                 <div className="md:w-2/5 bg-slate-100 relative">
                     ...
                     <div className="absolute top-4 left-4 flex gap-2">
                         <span className={`px-3 py-1 rounded-full text-xs font-bold shadow-sm backdrop-blur-md border border-white/20 ${
                            selectedCar.status === CarStatus.AVAILABLE ? 'bg-green-500/90 text-white' :
                ...
                <div className="relative h-48 overflow-hidden flex-shrink-0">
                  ...
                  <div className="absolute top-3 right-3">
                    <button 
                      ...
                      className={`px-3 py-1 rounded-full text-xs font-bold shadow-sm backdrop-blur-sm transition-all hover:scale-105 active:scale-95 cursor-pointer ${
                      car.status === CarStatus.AVAILABLE ? 'bg-green-100/90 text-green-700 hover:bg-green-100' :
